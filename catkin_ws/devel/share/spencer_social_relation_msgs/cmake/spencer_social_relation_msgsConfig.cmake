...
if("TRUE" STREQUAL "TRUE")
  set(spencer_social_relation_msgs_SOURCE_PREFIX /home/BB/catkin_ws/src/spencer_social_relation_msgs)
  set(spencer_social_relation_msgs_DEVEL_PREFIX /home/BB/catkin_ws/devel)
  ...
  set(spencer_social_relation_msgs_INSTALL_PREFIX /home/BB/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'spencer_social_relation_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Timm Linder <linder@informatik.uni-freiburg.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'spencer_social_relation_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/BB/catkin_ws/src/spencer_social_relation_msgs/${idir}'.  Ask the maintainer 'Timm Linder <linder@informatik.uni-freiburg.de>' to fix it.")
    endif()
...
set(spencer_social_relation_msgs_EXPORTED_TARGETS "spencer_social_relation_msgs_generate_messages_cpp;spencer_social_relation_msgs_generate_messages_lisp;spencer_social_relation_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${spencer_social_relation_msgs_dep}_FOUND)
      find_package(${spencer_social_relation_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${spencer_social_relation_msgs_dep} REQUIRED ${depend_list})
  endif()
